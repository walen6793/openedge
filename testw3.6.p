  ...
  where V_BelegPos.Firma        = {firma/vbelegko.fir '100'}
   ...
   do:
     DISPLAY
       ...
       bV_BelegPos.BelegNummer  LABEL "BelegNrL"
       V_BelegPos.BelegNummer  LABEL "BelegNrU"
